...
let virtual-env = "F:\Akis\Programming\Python\papadopoulou-app\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "F:\Akis\Programming\Python\papadopoulou-app\venv\Scripts\deactivate.nu"
